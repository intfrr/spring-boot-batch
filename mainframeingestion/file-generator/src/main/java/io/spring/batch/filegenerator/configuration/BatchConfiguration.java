...
public class BatchConfiguration {
	...
	public MultiResourceItemWriter<Store> multiResourceItemWriter() {
		return new MultiResourceItemWriterBuilder<Store>()
					...
					.resource(new FileSystemResource("C:\\Users\\rtalapaneni\\Documents\\work\\dev\\poc\\codebase\\git\\spring-boot-batch"))
	...
	public Dtar1000ItemWriter writer() {
		...
		dtar1000ItemWriter.setResource(new FileSystemResource("C:\\Users\\rtalapaneni\\Documents\\work\\dev\\poc\\codebase\\git\\spring-boot-batch"));
